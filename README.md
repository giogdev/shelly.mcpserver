...
1. Open the .env file and set the following variables:
	-	**SHELLY_API_KEY**: Your Shelly Cloud authorization key (read [blog post](https://www.thinkasadev.com/en/home-automation-into-your-ai-agent/) to know how to get auth key).
	-	**SHELLY_API_ENDPOINT**: The server URI for Shelly Cloud (e.g., https://shelly-52-eu.shelly.cloud, depends on your account).
